...
export const THEMES: Record<ThemeId, Theme> = {
  coastal: {
    ...
    skyGround: 0x9fc4d8,
    sunColor: 0xfff6d8,
    sunDirection: new THREE.Vector3(-0.62, 0.74, -0.26).normalize(),
    lightDirection: new THREE.Vector3(0.58, 0.76, 0.46).normalize(),
    sunSize: 0.05,
    halo: 0.85,
    starIntensity: 0,
    fogColor: 0xc9e2f4,
  ...
  desert: {
    ...
    skyGround: 0xb4643a,
    sunColor: 0xffd08a,
    sunDirection: new THREE.Vector3(0.2, 0.075, -0.977).normalize(),
  ...
  night: {
    ...
    skyGround: 0x080a16,
    sunColor: 0xe6ecff,
    sunDirection: new THREE.Vector3(0.66, 0.6, -0.45).normalize(),
    ...
    sunIntensity: 1.15,
    sunLightColor: 0xa8bcff,
    ambientSky: 0x3a4f92,
    ambientGround: 0x111526,
